const char *biotite_ver(void) { return "$Id: biotite.c,v 1.3 2006/10/20 00:59:22 ghiorso Exp $"; }
/*
MELTS Source Code: RCS $Log: biotite.c,v $
...
MELTS Source Code: RCS
 * Revision 3.7  1997/06/21  22:50:10  ghiorso
 * June 1997 MELTS 3.0.x release
 * (prior to new entropy and regression model being introduced)
 *
 * Revision 3.6  1997/05/03  20:23:44  ghiorso
 * *** empty log message ***
 *
 * Revision 3.5  1997/03/27  17:03:52  ghiorso
 * *** empty log message ***
 *
 * Revision 3.4  1996/09/24  20:33:53  ghiorso
 ...
 * implemented.
 *
 * Revision 3.1  1995/08/18  17:15:56  ghiorso
...
**
**      V1.0-1  Mark S. Ghiorso  April 5, 1992 Original Version
**              Preliminary model - Regular solution theory with
**                                  T-, P - independent parameters
 ...
 */
int
testBio(int mask, double t, double p,
...
void
conBio(int inpMask, int outMask, double t, double p,
...
void
dispBio(int mask, double t, double p, double *x,
...
void 
actBio(int mask, double t, double p, double *x, 
...
void 
gmixBio(int mask, double t, double p, double *x, 
...
void 
hmixBio(int mask, double t, double p, double *x, 
...
void 
smixBio(int mask, double t, double p, double *x, 
...
void 
cpmixBio(int mask, double t, double p, double *x, 
...
void 
vmixBio(int mask, double t, double p, double *x, 

const char *amphibole_ver(void) { return "$Id: amphibole.c,v 1.3 2006/10/20 00:59:22 ghiorso Exp $"; }
/*
 ...
 */
int
testAph(int mask, double t, double p,
...
void
conAph(int inpMask, int outMask, double t, double p,
...
*/
        ...
        if (outMask & ~(THIRD | FOURTH | FIFTH | SIXTH | EIGHTH))
            printf("Illegal call to conAph with inpMask = %o and outMask = %o\n",
                inpMask, outMask);
...
void
dispAph(int mask, double t, double p, double *x,
...
void
actAph(int mask, double t, double p, double *x,
...
void
gmixAph(int mask, double t, double p, double *x,
...
void
hmixAph(int mask, double t, double p, double *x,
...
void
smixAph(int mask, double t, double p, double *x,
...
void
cpmixAph(int mask, double t, double p, double *x,
...
void
vmixAph(int mask, double t, double p, double *x,

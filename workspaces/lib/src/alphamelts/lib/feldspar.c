const char *feldspar_ver(void) { return "$Id: feldspar.c,v 1.3 2006/10/20 00:59:22 ghiorso Exp $"; }
/*
MELTS Source Code: RCS $Log: feldspar.c,v $
...
**  MODULE DESCRIPTION:
**
**      Routines to compute feldspar solution properties
**      (file: FELDSPAR.C)
**
...
// Compare 19487.0 on anorthite
#define KSP_ADJUSTMENT    -39970.0
#endif
...
#ifndef TESTDYNAMICLIB
static double whaban   = -19487.0;   /* joules     */
static double whanab   = -19487.0;   /* joules     */
#else
static double whaban   = 7924.0;   /* joules     */
static double whanab   = 0.0;      /* joules     */
#endif
#ifndef TESTDYNAMICLIB
static double whoran   = 19487.0;  /* joules     */
static double whanor   = 19487.0;  /* joules     */
#else
...
#ifndef TESTDYNAMICLIB
static double whabanor = 12545.0+(3962.0+39645.5+KSP_ADJUSTMENT);  /* joules     */
#else
 ...
 */
int
testFld(int mask, double t, double p,
...
void
conFld(int inpMask, int outMask, double t, double p,
    double *e,      /* comp of feldspar in moles of elements                    */
    double *m,      /* comp of feldspar in moles of endmember components        */
    double *r,      /* comp of feldspar in terms of the independent comp var    */
    double *x,      /* comp of feldspar in mole fractions of endmember comp     */
...
void
dispFld(int mask, double t, double p, double *x,
...
void
actFld(int mask, double t, double p, double *x,
...
void
gmixFld(int mask, double t, double p, double *x,
...
void
hmixFld(int mask, double t, double p, double *x,
...
void
smixFld(int mask, double t, double p, double *x,
...
void
cpmixFld(int mask, double t, double p, double *x,
...
void
vmixFld(int mask, double t, double p, double *x,
